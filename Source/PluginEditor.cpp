...
//  (Our component is opaque, so we must completely fill the background with a solid colour)
    ...
    auto areaVol = area.removeFromLeft(area.getWidth() * 2/17).reduced(4, 4);   
// 	auto areaLFO = area.removeFromLeft(area.getWidth() * 2/18).reduced(4, 4);   
    auto areaDCO = area.removeFromLeft(area.getWidth() * 7/15).reduced(4, 4);
...
// 	g.drawFittedText ("LFO", topLFO, Justification::centred, 1);
    ...
    // 	PW Modulation texts
    Rectangle<int> pwModRect (areaVol.getWidth() + areaDCO.getWidth()* 1/7 - 4, 140, 90, 45);
    g.setFont (10.0f);
...
/*  g.drawLine (areaVol.getWidth() + areaLFO.getWidth()+16, 40, 
    ...
    g.drawLine (areaVol.getWidth() + areaDCO.getWidth()+16, 40,  
    			areaVol.getWidth() + areaDCO.getWidth()+16, area.getHeight()-14);
    g.drawLine (areaVol.getWidth() + areaDCO.getWidth() + areaVCF.getWidth()+24, 40,  
    			areaVol.getWidth() + areaDCO.getWidth() + areaVCF.getWidth()+24, area.getHeight()-14);
    // 	DCO Lines
    int x1 = (areaDCO.getWidth() * 0/7 + 37) + areaVol.getWidth()+3;
    int x2 = (areaDCO.getWidth() * 1/7 + 12) + areaVol.getWidth()+3;
    int x3 = (areaDCO.getWidth() * 2/7 + 37) + areaVol.getWidth()+3;
    g.drawLine (x1, 45, x3, 45, 1);
    g.drawLine (x1, 45, x1, 50, 1);
    g.drawLine (x2, 45, x2, 110, 1);
    g.drawLine (x3, 45, x3, 50, 1);
    x1 = (areaDCO.getWidth() * 4/7 + 37)+ areaVol.getWidth()+0;
    x2 = (areaDCO.getWidth() * 5/7 + 37)+ areaVol.getWidth()+0;
